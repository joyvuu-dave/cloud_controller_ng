module VCAP::CloudController
  class AppUsageSnapshot < Sequel::Model(:app_usage_snapshots)
    ...
    # During snapshot generation, we first count processes via SQL, then batch-insert
    ...
    #
    # HOW IT WORKS:
    # - process_count is set from SQL COUNT(*) BEFORE inserting details
    ...
    def integrity_valid?
      complete? && process_count == app_usage_snapshot_details.count
    end
  end
end
