...
module VCAP::CloudController::Presenters::V3
  class ServiceUsageConsumerPresenter < BasePresenter
    def to_hash
      {
        guid: service_usage_consumer.guid,
        consumer_guid: service_usage_consumer.consumer_guid,
    ...
    def build_links
      {
        self: {
          href: url_builder.build_url(path: "/v3/service_usage_consumers/#{service_usage_consumer.guid}")
        }
      }
    end
  end
