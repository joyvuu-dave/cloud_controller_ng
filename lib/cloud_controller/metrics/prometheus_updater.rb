...
module VCAP::CloudController::Metrics
  class PrometheusUpdater
    ...
    METRICS = [
      ...
      { type: :gauge, name: :cc_app_usage_snapshot_instance_count, docstring: 'Number of instances in last generated app usage snapshot', aggregation: :most_recent },
      ...
      { type: :gauge, name: :cc_app_usage_snapshot_cleaned_up_total, docstring: 'Number of app usage snapshots cleaned up', aggregation: :most_recent },
      ...
      { type: :gauge, name: :cc_service_usage_snapshot_cleaned_up_total, docstring: 'Number of service snapshots cleaned up', aggregation: :most_recent }
    ].freeze
