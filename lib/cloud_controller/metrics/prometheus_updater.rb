...
module VCAP::CloudController::Metrics
  class PrometheusUpdater
    ...
    METRICS = [
      ...
      { type: :histogram, name: :cc_app_usage_snapshot_generation_duration_seconds, docstring: 'Time taken to generate usage snapshots', buckets: DELAYED_JOB_METRIC_BUCKETS },
      { type: :gauge, name: :cc_app_usage_snapshot_process_count, docstring: 'Number of processes in last generated snapshot', aggregation: :most_recent },
      { type: :counter, name: :cc_app_usage_snapshot_generation_failures_total, docstring: 'Total number of failed snapshot generations' },
      { type: :gauge, name: :cc_usage_snapshots_cleaned_up_total, docstring: 'Number of snapshots cleaned up', aggregation: :most_recent }
    ].freeze
